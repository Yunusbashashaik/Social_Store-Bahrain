export const COPY = {
  en: {
    ...
    catalogEmpty: "No subscriptions yet.",
    ...
    adminExportCatalog: "Export catalog backup",
    adminImportCatalog: "Import catalog backup",
    adminExported: "Catalog backup downloaded.",
    adminImported: "Catalog restored from backup.",
    adminImportInvalid: "Choose a valid admin-state.json file.",
    adminConfirmImportTitle: "Restore catalog from file",
    adminConfirmImportBody:
      "Replace the live catalog with this backup? Current services will be overwritten.",
  ...
  ar: {
    ...
    catalogEmpty: "لا توجد اشتراكات بعد.",
    ...
    adminExportCatalog: "تصدير نسخة الكتالوج",
    adminImportCatalog: "استيراد نسخة الكتالوج",
    adminExported: "تم تنزيل نسخة الكتالوج.",
    adminImported: "تم استعادة الكتالوج من النسخة الاحتياطية.",
    adminImportInvalid: "اختر ملف admin-state.json صالح.",
    adminConfirmImportTitle: "استعادة الكتالوج من ملف",
    adminConfirmImportBody:
      "هل تريد استبدال الكتالوج الحالي بهذه النسخة؟ سيتم استبدال الخدمات الحالية.",
