export const COPY = {
  en: {
    brandName: "Social Store",
    brandTagline: "PREMIUM SUBSCRIPTIONS · DIGITAL SERVICES",
    basedIn: "BAHRAIN",
    basedInSuffix: "Based",
    heroKicker: "Premium Subscriptions, Digital Services",
    heroBadge: "ALL PREMIUM SUBSCRIPTIONS",
    ...
    tagline:
      "Get your favorite streaming, VPN, and digital tools at the best prices.",
    heroCta: "Explore Subscriptions",
    heroMore: "More",
    heroComboTitle: "Netflix + Prime Combo",
    heroNote: "More Apps · More Entertainment · Better Prices",
    heroTrust: [
      { icon: "bolt", title: "Fast Delivery", body: "Instant Activation" },
      { icon: "headset", title: "24/7 Support", body: "Always Here" },
      { icon: "shield", title: "Secure & Trusted", body: "Safe Payments" },
    ],
    ...
    trustBarDetailed: [
      { icon: "bolt", title: "Instant Delivery", body: "Get Access Quickly" },
      { icon: "shield", title: "100% Secure", body: "Safe & Reliable" },
      { icon: "headset", title: "24/7 Support", body: "We're Always Here" },
      { icon: "globe", title: "Bahrain Based", body: "Serving You Better" },
      { icon: "users", title: "Trusted by Customers", body: "Thousands of Happy Users" },
    ],
    ...
    catalogTitle: "Our Premium Subscriptions",
    catalogLead: "Top streaming, VPN and digital services — all in one place.",
    viewAll: "View All",
    showLess: "Show Less",
    ...
    footerOwnerLabel: "Owner By",
    footerWhatsAppOnly: "WhatsApp Only",
    footerOrderNow: "Order Now",
    footerSlogan: "Same passion, bigger entertainment in Bahrain",
  ...
  ar: {
    brandName: "Social Store",
    brandTagline: "اشتراكات مميزة · خدمات رقمية",
    basedIn: "البحرين",
    basedInSuffix: "مقرنا",
    heroKicker: "اشتراكات مميزة وخدمات رقمية",
    heroBadge: "جميع الاشتراكات المميزة",
    ...
    tagline:
      "احصل على خدمات البث وVPN والأدوات الرقمية المفضلة لديك بأفضل الأسعار.",
    heroCta: "استكشف الاشتراكات",
    heroMore: "المزيد",
    heroComboTitle: "باقة نتفليكس + برايم",
    heroNote: "تطبيقات أكثر · ترفيه أكبر · أسعار أفضل",
    heroTrust: [
      { icon: "bolt", title: "توصيل سريع", body: "تفعيل فوري" },
      { icon: "headset", title: "دعم 24/7", body: "دائماً معك" },
      { icon: "shield", title: "آمن وموثوق", body: "مدفوعات آمنة" },
    ],
    ...
    trustBarDetailed: [
      { icon: "bolt", title: "توصيل فوري", body: "احصل على الوصول بسرعة" },
      { icon: "shield", title: "آمن 100٪", body: "موثوق وآمن" },
      { icon: "headset", title: "دعم 24/7", body: "نحن دائماً هنا" },
      { icon: "globe", title: "مقرنا البحرين", body: "نخدمك بشكل أفضل" },
      { icon: "users", title: "موثوق من العملاء", body: "آلاف العملاء السعداء" },
    ],
    ...
    catalogTitle: "اشتراكاتنا المميزة",
    catalogLead: "أفضل خدمات البث وVPN والخدمات الرقمية — كلها في مكان واحد.",
    viewAll: "عرض الكل",
    showLess: "عرض أقل",
    servicesShown: "خدمات",
    ...
    footerOwnerLabel: "المالك",
    footerWhatsAppOnly: "واتساب فقط",
    footerOrderNow: "اطلب الآن",
    footerSlogan: "نفس الشغف، ترفيه أكبر في البحرين",
