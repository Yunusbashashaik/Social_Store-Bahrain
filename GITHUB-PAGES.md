...
GitHub Pages serves this repo from **`main` / (root)**. The built homepage, `assets/`, `logo.png`, and wallpaper therefore live at the **repository root** as well as in `docs/`. If those files are missing from root, the store URL is a blank white page.
